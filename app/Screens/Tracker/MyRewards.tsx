...
import { Icon, RewardOption, RewardOptionContainer, RewardOptionTitle, RewardOptionWrapper, RewardsBackContainer, RewardsBodyContainer, RewardsBodyDescription, RewardsBodyTitle, RewardsContainer, RewardsFooterContainer, RewardsHeaderContainer, RewardsHeaderTitle, RewardsTag, RewardsTagContainer, RewardsTagWrapper, RewardsWrapper } from '../Rewards//Rewards.styled'
import { Props } from '../../Utils/utility_functions/utilityFunctions'
import { AppContext } from '../../data_storage/contextApi/AppContext'

const MyRewards: FC<Props> = ({ navigation }) => {
  const { goalObject, setGoalObject, signupInProgress } = useContext(AppContext)
        ...
        <RewardsContainer>
          ...
          <RewardsFooterContainer>
            <AppButton disabled={reward.length < 1} buttonLabel={'Continue'} onPress={() => {
              ...
              navigation.navigate('GoalCommitment')
            }} />
          </RewardsFooterContainer>
        </RewardsContainer>
      </KeyboardAvoidingView>
