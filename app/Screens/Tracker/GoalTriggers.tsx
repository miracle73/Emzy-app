...
import { Icon, TriggersBackContainer, TriggersBodyContainer, TriggersBodyTitle, TriggersContainer, TriggersFooterContainer, TriggersHeaderContainer, TriggersHeaderTitle, TriggersTag, TriggersTagContainer, TriggersTagDescription, TriggersTagTitle, TriggersTagWrapper, TriggersWrapper } from '../Triggers/Triggers.styled'
import { Props } from '../../Utils/utility_functions/utilityFunctions'
import { AppContext } from '../../data_storage/contextApi/AppContext'


const GoalTriggers: FC<Props> = ({ navigation }) => {
