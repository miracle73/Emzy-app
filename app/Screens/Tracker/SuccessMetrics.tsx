...
import { Icon, MetricsBackContainer, MetricsBodyContainer, MetricsContainer, MetricsFooterContainer, MetricsHeaderContainer, MetricsHeaderDescription, MetricsHeaderTitle, ModalBodyContainer, ModalContainer, ModalWrapper, ModelBodyDescription } from '../Metrics/Metrics.styled'
import { Props } from '../../Utils/utility_functions/utilityFunctions'
import { AppContext } from '../../data_storage/contextApi/AppContext'
import { KeyboardAwareScrollView } from 'react-native-keyboard-aware-scroll-view'

const SuccessMetrics: FC<Props> = ({ navigation }) => {
